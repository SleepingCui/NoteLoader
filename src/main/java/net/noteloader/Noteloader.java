...
public class Noteloader implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        log.info("NoteLoader {} successfully loaded.", FabricLoader.getInstance().getModContainer("noteloader").map(ModContainer::getMetadata).map(meta -> meta.getVersion().getFriendlyString()).orElse("unknown"));
    }
}